...
void aggData(string fileName, int tid, int wr[][NUM_OF_SECTORS][NUM_OF_SPEED]);
...
int main(){
	...
	{
		int __attribute__((aligned(64))) local_wr[threadNums][NUM_OF_SECTORS][NUM_OF_SPEED] = {0};
